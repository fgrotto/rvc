...
function [q,d_q,dd_q,ddd_q] = fifth_order_trajectory(qi, dot_qi, dot_dot_qi, qf, dot_qf, dot_dot_qf, ti, tf, Ts)
   ...
   ddd_q = 60*x(1)*t.^3+24*x(2)*t.^1+6*x(3);
end
